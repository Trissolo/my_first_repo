...
def tuple_to_string(t):
    #print(t)
    return t #separator.join(str(int(x)) for x in t)
...
things_sorted_by_depth = sorted(
    room_element_list, key=lambda x: depth_categories[x["depth"]], reverse=False
)
...
main_container["things"] = things_sorted_by_depth  # room_element_list
